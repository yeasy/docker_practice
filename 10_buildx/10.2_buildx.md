...
> **⚠️ 注意与失败模式**：
> 要使 SBOM（或其他 attestation 元数据）成功附着并可见，对底层的存储格式有前置要求：默认的 classic image store 不支持 manifest list/index 这种存放 attestation 的结构。
>
...
* [Docker buildx 命令文档](https://docs.docker.com/reference/cli/docker/buildx/)
