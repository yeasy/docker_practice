...
> **版本说明**：Buildah 与 Podman 和 Skopeo 共同维护。建议查阅 [Buildah 官方文档](https://buildah.io/) 和 [GitHub Releases](https://github.com/podman-container-tools/buildah/releases) 了解最新版本。
