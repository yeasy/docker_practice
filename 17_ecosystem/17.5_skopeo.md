...
> **版本说明**：Skopeo 与 Podman、Buildah 同属 `podman-container-tools` 项目生态。建议访问 [Skopeo 官方仓库](https://github.com/podman-container-tools/skopeo) 和 [GitHub Releases](https://github.com/podman-container-tools/skopeo/releases) 获取最新版本信息。
...
```
如果我们要将本地的某个目录下的打包好的镜像再次推向 Registry 或转换为其他存储类型也是完全支持的，诸如：
